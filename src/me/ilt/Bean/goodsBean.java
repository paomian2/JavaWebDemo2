...
public class goodsBean {
	...
	public goodsBean(int id,String name,double price,String proPic) {
		this.id = id;
		this.name = name;
		this.price = price;
		this.proPic = proPic;
	...
	public goodsBean(String name, double price, String proPic, String brand,
			int sales, int views, int stock, String contents,int bigTypeId, int smallTypeId,String state) {
		this.name = name;
		this.price = price;
		this.proPic = proPic;
		this.brand = brand;
