...
<table id="dg" title="商品小类管理" class="easyui-datagrid" fitColumns="true" 
    pagination="true" rownumbers="true" url="../sel.small" fit="true" toolbar="#tb">
    <thead>
    	<tr>
...
<div id="dlg" class="easyui-dialog" style="width: 670px;height: 350px;padding: 10px 20px"
  ...
  <form id="fm" method="post">
  	<table cellspacing="8px;">
  	    <tr>
  			<td>所属大类：</td>
  			<td colspan="4"><input class="easyui-combobox" id="bName" name="productSmallType.bigTypeId"  data-options="panelHeight:'auto',editable:false,valueField:'id',textField:'name',url:'../selList.big'"/></td>
  		</tr>
  		<tr>
  			<td>小类名称：</td>
